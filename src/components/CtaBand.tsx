          ...
          <div className="grid items-end gap-12 lg:grid-cols-12">
            <div className="lg:col-span-7">
              ...
              <p className="mt-7 max-w-xl text-xl leading-relaxed text-ink-soft">
                The first call is about what you are deciding and what your
                current numbers can and cannot answer. If we are not the right
                team for it &mdash; or you only need one of the three tiers &mdash;
